...
public interface IProcessor {
  ...
  Optional<NewsReturn> createNews(String title, String description, String imageUrl, String author, LocalDateTime date,
      String content);

  Optional<NewsReturn> getNews(int id);

  Optional<NewsReturn> updateNews(int id, String title, String description, String imageUrl, String author,
  ...
  Optional<ApplicantReturn> createApplicant(int userId, byte[] fileBLOB, String fileType, String[] interests,
      String priorInvolvement, String whyJoin);

  Optional<ApplicantReturn> getApplicant(int userId);

  Optional<ApplicantReturn> updateApplicant(int userId, byte[] fileBLOB, String fileType, String[] interests,
      String priorInvolvement, String whyJoin);
  ...
  Optional<EventReturn> createEvent(String name, String subtitle, String description, String imageUrl,
      LocalDateTime date, boolean open, String eventCode);

  Optional<EventReturn> getEvent(int id);

  Optional<EventReturn> updateEvent(int id, String name, String subtitle, String description, String imageUrl,
  ...
  Optional<UserReturn> addUser(String email, String first, String last, String hashedPassword, int currentYear,
  ...
  Optional<UserReturn> updateUser(int id, String email, String first, String last, String hashedPassword,
